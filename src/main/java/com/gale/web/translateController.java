...
public class translateController {
	...
	private String add(@RequestParam(value = "suggestion") String suggestion) {
		Suggestion sug = new Suggestion(suggestion);
		suggestionService.addSuggestion(sug);
		return "thanks";
	}
	@RequestMapping(value = "/list", method = RequestMethod.GET)
	private String list(Model model) {
		List<Suggestion> list = suggestionService.getList();
		model.addAttribute("list", list);
		return "list";
	}
	@RequestMapping(value = "/delete", method = RequestMethod.GET)
	private String delete(@RequestParam(value = "id") int id, Model model) {
